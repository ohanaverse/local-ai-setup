<!--
  Extracted from Claude Code v2.1.277
  Source offset: 178816766
  Content hash: f36f3b29b45df9a7
...
When building the list, work through these checks and include only what applies:${rae()?