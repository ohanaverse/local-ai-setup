<!--
  ...
  Source offset: 173951342
  Content hash: a69d40cb3c77b5f4
  Category: hooks
...
- The `<summary>` describes the outcome: "finished", "failed: {error}", "was stopped", or "stopped at its N-turn limit" (partial result; continue it with  to the task-id)
