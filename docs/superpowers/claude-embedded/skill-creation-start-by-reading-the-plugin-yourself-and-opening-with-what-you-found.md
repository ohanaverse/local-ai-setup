<!--
  ...
  Source offset: 197426396
  Content hash: 88186f0e6cb22a7b
  Category: skill-creation
  Auto-generated — do not edit manually
-->

/`. Start by reading the plugin yourself and opening with what you found.
...
- The plugin under test is READ-ONLY. Never Edit/Write any file under `skills/`, `commands/`, or `.claude-plugin/`. If the author asks you to fix the plugin, say "file that as a follow-up — I'll test the plugin as it is now." You write only under `/`.
