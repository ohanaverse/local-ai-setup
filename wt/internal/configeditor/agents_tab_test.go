...
func (d *stubCommandDriver) Build(_ config.Model, _ bool, _ agents.Route) agents.LaunchCmd {
...
func (d *stubAgentDriver) Build(_ config.Model, _ bool, _ agents.Route) agents.LaunchCmd {
	return agents.LaunchCmd{}
}
